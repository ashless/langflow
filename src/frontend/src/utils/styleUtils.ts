...
export const SIDEBAR_CATEGORIES = [
  { display_name: "COMPONENTS.Saved", name: "saved_components", icon: "GradientSave" },
  { display_name: "COMPONENTS.I/O", name: "input_output", icon: "Cable" },
  { display_name: "COMPONENTS.Inputs", name: "inputs", icon: "Download" },
  { display_name: "COMPONENTS.Outputs", name: "outputs", icon: "Upload" },
  { display_name: "COMPONENTS.Prompts", name: "prompts", icon: "braces" },
  { display_name: "COMPONENTS.Models", name: "models", icon: "BrainCog" },
  { display_name: "COMPONENTS.Data", name: "data", icon: "Database" },
  { display_name: "COMPONENTS.Processing", name: "processing", icon: "ListFilter" },

  { display_name: "COMPONENTS.Vector Stores", name: "vectorstores", icon: "Layers" },
  { display_name: "COMPONENTS.Agents", name: "agents", icon: "Bot" },
  { display_name: "COMPONENTS.Chains", name: "chains", icon: "Link" },
  { display_name: "COMPONENTS.Loaders", name: "documentloaders", icon: "Paperclip" },
  { display_name: "COMPONENTS.Link Extractors", name: "link_extractors", icon: "Link2" },
  { display_name: "COMPONENTS.Output Parsers", name: "output_parsers", icon: "Compass" },
  { display_name: "COMPONENTS.Prototypes", name: "prototypes", icon: "FlaskConical" },
  { display_name: "COMPONENTS.Retrievers", name: "retrievers", icon: "FileSearch" },
  { display_name: "COMPONENTS.Text Splitters", name: "textsplitters", icon: "Scissors" },
  { display_name: "COMPONENTS.Toolkits", name: "toolkits", icon: "Package2" },
  { display_name: "COMPONENTS.Tools", name: "tools", icon: "Hammer" },
  { display_name: "COMPONENTS.Logic", name: "logic", icon: "ArrowRightLeft" },
  { display_name: "COMPONENTS.Helpers", name: "helpers", icon: "Wand2" },
];
